void World::Build()
{
	...
	reflective_ptr1->SetCr(RGBColor(0, 0, 1));
	...
	reflective_ptr2->SetKa(0.0);
	reflective_ptr2->SetKd(0.0);
	reflective_ptr2->SetCd(black);
	reflective_ptr2->SetKs(0.0);
	reflective_ptr2->SetExp(1.0);
	reflective_ptr2->SetKr(0.7);
	reflective_ptr2->SetCr(RGBColor(1, 0, 0));
	...
	reflective_ptr3->SetKa(0.0);
	reflective_ptr3->SetKd(0.0);
	reflective_ptr3->SetCd(0, 0.5, 0.75);
	reflective_ptr3->SetKs(0.0);
	reflective_ptr3->SetExp(100.0);
	reflective_ptr3->SetKr(0.75);
	reflective_ptr3->SetCr(RGBColor(0, 1, 0));
