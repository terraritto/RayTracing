...
SmoothUVMeshTriangle::SmoothUVMeshTriangle(std::shared_ptr<Mesh> mesh_ptr, const int i0, const int i1, const int i2)
...
std::shared_ptr<SmoothUVMeshTriangle> SmoothUVMeshTriangle::Clone() const
{
	return std::make_shared<SmoothUVMeshTriangle>(*this);
}

bool SmoothUVMeshTriangle::hit(const Ray& ray, double& tMin, ShadeRec& sr)
{
